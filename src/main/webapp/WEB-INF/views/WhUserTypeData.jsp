	...
	<div class="container mt-4 mb-4">
		<div class="card">
			...
			<div class="card-header bg-info text-white">
				<h2>WELCOME TO WH USER DATA PAGE</h2>
			</div>
			<!-- card header end -->
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<table class="table table-bordered table-hover table-responsive mt-3">
							...
							<c:forEach items="${list}" var="whu">
								<tr>
									<td><c:out value="${whu.userId}" /></td>
									<td><c:out value="${whu.userType}" /></td>
									<td><c:out value="${whu.userEmail}" /></td>
									<td><c:out value="${whu.userContact}" /></td>
									<td><a href="delete?wid=${whu.userId}"> <img
											src="../resources/images/delete.png" width="20" height="20" />
									</a></td>
									<td><a href="viewOne?wid=${whu.userId}"> <img
											src="../resources/images/view.png" width="20" height="20" />
									</a></td>
									<td><a href="editOne?wid=${whu.userId}"> <img
											src="../resources/images/edit.png" width="20" height="20" />
									</a></td>
									<td><a href="exportExcelOne?wid=${whu.userId}"> <img
											src="../resources/images/excel.png" width="20" height="20" />
									</a></td>
									<td><a href="exportPdfOne?wid=${whu.userId}"> <img
