				...
				<form:form action="insert" method="post" modelAttribute="item">
					...
					<div class="row mb-3">
						...
						<div class="col-2">
							...
							<form:errors path="itemWidht" class="text-danger"/>
						</div>
						<div class="col-2">
							<label>LENGTH</label>
					...
					<div class="row mb-3">
						...
						<div class="col-6">
							...
							<form:errors path="baseCost" class="text-danger"/>
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-6">
							...
							<form:errors path="baseCurr" class="text-danger"/>
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-6">
							...
							<form:errors path="itemDsc" class="text-danger"/>
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-6">
							<form:select path="orderMethod.oid" class="form-control">
								<form:option value="">-select-</form:option>
								<form:options items="${oms}" itemLabel="orderMode" itemValue="oid"/>
							</form:select>
